const collective_wisdom = [
	...
	// How can you derive this lessons learned to applpy this strategy in your life or work? | Or learning by your own?
	{
		...
		description:
			'I know that it looks like extra work, especially after so many hours of work, but you should either: \n\
        ...
        ',
		example:
			'Either flashcards or terminology compilation of the exercise for long term memory storage and residual learning.'
	},
	{
	...
	},
	{
		...
		example:
			'Start watching the youtube videos related to the topic, to give you an intuitive understanding of the topic.'
	},
	{
		term: 'start-of-weekend',
		prompt: 'What to do at the start of the weekend?',
		example:
			'Download the proper Yotube videos on yoru phone, look up the homework.'
	},
	{
		term: 'priority-for-exam',
		prompt: 'What should be your priority when studying for an exam?',
		description:
			'For example for Your AI class you should have absolutelly studied the homework as the FIRST layer\n\
