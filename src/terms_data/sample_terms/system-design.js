...
const system_design_project = [
	{
		term: 'stakeholders',
		description:
			'People who have an interest in the project: designers, frontend developers, accessibility experts, content strategist, researchers, performance experts, product managers, leaders\n\
...
const API_design = [
	{
		...
		description:
			'High cohesion refers to code that within a module is all closely related to the same function\n\n\
	...
	},
	{
		...
		description:
			'They don’t have the context of why data model design decisions were made. Great API \n\
	...
	},
	{
		...
		example:
			'A smart way is to have two releases. On each release, is devided in two aspects, designing of the API and the second (API Delivery, Frontend Implementation and Customer Feedback)'
	},
	{
