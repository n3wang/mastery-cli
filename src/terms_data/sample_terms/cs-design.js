...
const dsa = [
	...
	},
	{
        ...
        ',
		example:
			'On calculator iteration, there was no + - in the end(likely) but you still had to add the number generated into the stack. As well as solving all the non-inside parenthesis operations'
	},
	{
        ...
        ',
		example:
			'On Calculator problem, having the reorderring of the stack made sense because you wouldnt have the issue with minus simbols, when collapsing the parenthesis\n\
...
const system_design = [
	...
	{
		term: 'Reliability',
		prompt: 'Whats the difference between reliability and availability?',
		description:
	...
	},
	{
		...
		term: 'Scalability',
		prompt: 'When scalability becomes important? | \n\
	...
	{
		term: 'Vertical Scaling vs Horizonal scalling',
		prompt: 'Whats the difference?',
		example:
			"a. Vertical Scaling  When you add more storage, RAM, GPU power, and CPU to an existing system you have, it is called Scaling Vertically. \n\n\
	...
	{
		term: 'Redundanacy & Replication',
		prompt: 'Why they are useful? What are their advantages?',
		description:
	...
	{
		term: 'Proxies',
		prompt: 'How could you use Proxies in Maid CLI (or other current project?)',
		description:
	...
	},
	{
		...
		prompt: 'Advantages of partitioning Horizontally vs Vertically?',
	...
	{
		term: 'Indexing',
		prompt: 'how fast can this indexes mean?',
		description:
	...
	},
	{
		...
		prompt: 'What are their advantages? | Sumarize ACID Properties | How could they be used to refactor/business/UX Design? | What examples can you find?',
		description:
		...
		example:
			'ACID compliance offers multiple benefits: Data integrity. Using ACID-compliant systems guarantees your data will be accurate, valid, and in line with the constraints you impose on the system. Simplified operational logic\n\
	...
	},
	{
		...
		prompt: 'When to use BASE properties vs ACID ? What are the advantages and disadvatanges in comparison?',
		description:
	...
	{
		term: 'CAP Theorem',
		prompt: "How would you rate your current application in the CAP Theorem framework's axis?",
		description:
	...
	},
	{
		...
		prompt: 'What services use this? | Explain how this works in your own words?',
		description:
	...
	},
	{
		...
		example:
			'application-visible sharding policy using relational databases… \n\
	...
	{
		term: 'Long polling',
		prompt: 'What are the advantages or disadvantages of Long Polling? | How could u use this in a Dog and Cats Images API ? How about in an AI model (or your porjject)',
		description:
	...
	{
		term: 'Web Sockets',
		prompt: 'Why it has this advantages? When could this be used?',
		description:
		...
		example:
			'This can be used for: Real time Feeds, Real Time Multiplayer Gaming, Collaborative Editing, Data Visualization, Multimedia Chat, Real Time Location, Real Time Recommendation Clicking., Real time Sports: Streaming, Event Updates (w input)'
	},
	{
		term: 'Server-Sent Events',
		prompt: 'Whats the difference between this and Web Sockets?',
		description:
	...
	{
		term: 'Aggregation',
		prompt: 'How is it symbolized? What does it mean? Make an example when you would be using this',
		example: ''
	},
	{
		term: 'system design',
...
const design_patterns = [
   ...
   Advantages: Doesn't  implement methods we dont need. Increases readability and maintainability of our code.",
	...
	},
	{
		...
		prompt: '',
		example:
			"the Bridge design pattern is like having a remote control for your TV. The remote control is the abstraction, and the TV is the implementation. The remote control lets you change the channel, turn the volume up and down, and do other things, but it doesn't actually do anything on its own. It just sends signals to the TV, which is the part that actually changes the channel and adjusts the volume.\n \
        \n \
	...
	},
	{
		...
		example:
			'Use promises for populating a site page statically, or get a report, while if you want a dynamic page, or a stream of data, use observables.'
	}
];
