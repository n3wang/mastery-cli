const react_terms = [
	{
		term: 'Compilers',
		prompt: 'What is a compiler in JS in OTerms? Whats their function?',
		description:
	...
	{
		term: 'Bundlers',
		prompt: 'What are Bundlers in JS and CSS? and whats their function?',
		description:
		...
		example:
			'Similar to Linking, which means creating a single executable file from several multiple object files. In this step, it is common that the linker will complain about undefined functions which are commonly main themselves.'
	},
	{
		term: 'Package Managers',
		prompt: 'What are Package Managers?',
		description:
...
const react_typescript = [
	...
	},
	{
		...
		example:
			'[counter, setCounter] = useState<CounterState>({\n\
            counter: initialValue,\n\
            clicks: 0,\n\
        });'
	},
...
const apex = [
	...
	},
	{
		...
		description:
			'Givena a table Account with columns: id, name, email, phone, createddate, createdbyid, lastmodifieddate, lastmodifiedbyid',
	...
	},
	{
        ...
        ',
		description:
			'List<Account> accounts = [SELECT Name, Industry, AnnualRevenue FROM '
	},
	{
        ...
        ',
		description:
			'List<Account> accounts = [SELECT Name, CloseDate FROM Opportunity...'
	},
	{
	...
	},
	{
        ...
        Account (1) [parent] ——> Contacts (n) [child]",
		example:
			':m `SELECT Name, Phone, Department, Account.Name, Account.Website FROM Contact`'
	},
	{
	...
	},
	{
		...
		example:
			":m existingAccount.Industry = 'Manufacturing';\nupdate existingAccount;\n\n\
...
const ide_s = [
	// Android Studio Shortcuts
	{
		...
		description:
			'     Ctrl+N — Navigate to Class     Ctrl+Shift+N — Navigate to a File     Ctrl+B — Jump to Declarations     Alt+ ↑ — Jump to the Previous Method     Alt+↓ — Jump to Next Method     Ctrl+G — Jump to Line     Ctrl+E — Recent Files     Ctrl+Shift+Backspace — Jump to Last Edited Location     Ctrl+B — Find Declarations     Ctrl+Left Mouse(or)Ctrl+Alt+F7— Show Usage     Alt + F7 / Ctrl + F7 — Find usages /Find usages in file     Ctrl+Shift+B — Find Implementations     F3 — Find Next     Shift+F3 — Find Previous ',
		prompt: 'Find a class named `Mock` | How to navigate to a file? ',
		example:
			'Ctrl+N Mock — Navigate to Class\n\n\
	...
	},
	{
		...
		example:
			'Ctrl Left mouse or Ctrl+B — Jump to Declarations => This will take you to the declaration of the method'
	},
	{
		...
		example:
			'Ctrl+Shift+N score.dart — Navigate to a File => This will take you to the file, the difference with recent is that it will take longer to search'
	},

	{
		...
		example:
			'Ctrl+Alt+F7— Show Usage => This will show you all the places where the method is used'
	},
	// Selection Keys
	{
		...
		example:
			'Alt + J — Select next occurrence => This will place a cursor on the same next word\n\n\
	...
	},
	{
		...
		example:
			'Ctrl+Shift+V — Paste from recent buffers (from a History of Copied Contents) => This will show you all the recent clipboard'
	},
	// Editing Keys
	{
		...
		example:
			'Ctrl+D — Duplicate a Line/Selected part => This will duplicate the line'
	},
	{
		...
		example:
			'Ctrl+Y — Delete a Line/Selected part => This will delete the line'
	},
	{
		...
		example:
			'Ctrl+Q — Quick Documentation => This will show you the documentation of the method'
	},
	{
		...
		example:
			'Ctrl + Space — Code completion => This will show you the suggestions'
	},
	{
		...
		example:
			'Ctrl + O — Override methods => This will show you the methods that you can override\n\n\
	...
	// Running and Debugging
	{
		...
		description:
			'     Ctrl + F9 — Compile and Run Make a project     Ctrl + Shift + F9 — Compile selected file, package or module     Shift + F10 — Run     Shift + F9 — Debug     Ctrl + Shift + F10 — Run context configuration from editor \n\
		...
		example:
			'Ctrl + F9 — Compile and Run Make a project => This will compile and run the project\n\
...
const flutter_dart = [
	...
	},
	{
		...
		description:
			'When creating a variable in Dart 2.12 or higher, you can add ? to the type to indicate that the variable can be null:     int? a = null; // Valid in null-safe Dart.  ',
	...
	},
	{
		...
		description:
			':m Dart offers some handy operators for dealing with values that might be null. One is the ??= assignment operator, which assigns a value to a variable only if that variable is currently null:\n\n\
        ```js\n\
	...
	},
	{
		...
		description:
			":m Here’s the same expression with a cascade:\n\
        ```js\n\
        myObject..someMethod()\n\
        ```\n\
	...
	},
	{
		...
		description:
			":m If you can’t completely handle the exception, use the rethrow keyword to propagate the exception:\n\
        ```js\n\
		...
		example:
			'finally is always executed, rethrow is used to propagate the exception'
	},
	{
	...
	},
	{
		...
		attachment:
			'https://blog.codemagic.io/uploads/2022/10/gesturewidget-1.png#center',
		description:
			":m\n\
        ```js\n\
	...
	},
	{
		...
		attachment:
			'https://blog.codemagic.io/dialogwidget_13619648723351944144_huebb6c3db760e71da697d69c329e419e5_0_1280x1800_fit_linear_3.png',
		description:
			":m\n\
        ```js\n\
	...
	},
	{
		...
		example:
			"[1] '/second': ((context) => const SecondScreen()),\n\
        [2] home: const MyApp()\n\
	...
	},
	{
		term: 'widget | Align',
		description:
			'Align this child in the following container (at the top and Right):\n\
        Center(child: Container(height: 120.0, width: 120.0, color: Colors.blue[50], child: ),)\n\n\
        children: F',
		example:
			'const Align(alignment: Alignment.topRight, child: F,)\n\n\
	...
	},
	{
		...
		example:
			"const Baseline(baseline: 80.0, baselineType: TextBaseline.alphabetic, child: Text('Baseline'),)"
	},
	{
		term: 'widget | LimitedBox',
		description:
			"A box that limits its size only when it's unconstrained. If the maximum width or height is not null, this widget will try to be that size, within the limits of its own constraints. If either is null, this widget will size itself to match the child's size in that dimension.",
		prompt: "Wrap the following widget with a LimitedBox with maxWidth: 150.0 and maxHeight: 150.0: Text('Limited Box')",
		example:
			"const LimitedBox(maxWidth: 150.0, maxHeight: 150.0, child: Text('Limited Box'),)"
	},
	{
		term: 'widget | Padding',
		description:
		...
		example:
			"const Padding(padding: EdgeInsets.all(20.0), child: Text('Padding'),)"
	},
	{
		...
		example:
			"const AspectRatio(aspectRatio: 16/9, child: Text('Aspect Ratio'),)"
	},
	{
		...
		example:
			"Scaffold(appBar: AppBar(title: Text('sample'),), body: Text('Scaffold'),)"
	},
	{
		...
		example:
			'[1] future = Future.delayed(const Duration(seconds: 8));\n\
	...
	// Buttons
	{
		...
		description:
			'A Material Design text button. Text buttons are typically used for less-pronounced actions, including those located in dialogs and cards. Text buttons are also a good choice for inline actions, such as in rows of data.',
		prompt: "Create a TextButton with onPressed: () => print('Pressed'), color of the text is white and child: Text('Text Button')",
		example:
			"TextButton(onPressed: () => print('Pressed'), child: Text('Text Button'), style: TextButton.styleFrom(primary: Colors.white),)"
	},
	{
		term: 'Flutter | loaders',
		description:
...
const chrome_extensions = [
	...
	},
	{
		...
		example:
			"chrome.storage.local.get(['name', 'card'], (result) => {\n console.log(result.key, result.card);\n});"
	},
	{
		...
		description:
			"Add a listener to element with id 'start-timer-btn' that listens for a click event and runs the code (template) in the callback",
		example:
	...
	},
	{
		...
		description:
			'Log the details on application being installed by using the requirements: contextMenus and background',
	...
	},
	{
		...
		description:
			":m Exercise: Fill create a context menu that activates in contexts `page` and `selection` and has the title `Read This Text` and the id `contextMenu2`\n\
	...
	},
	{
		...
		description:
			':m This is how you match all urls:\n\
        content_scripts": [\n {\n "matches": ["<all_urls>"],\n "js": ["contentScript.js"]\n }\n]',
		example:
			':m\n\
        ```js\n\
	...
	},
	{
		...
		description:
			":m Create a listener for the following code at `contentScript.js` that gets activated when the website is matched\n\
        ```js\n\
...
const python_frameworks = [
	{
		...
		description:
			'You are looking for a library to manage your postgresql database in your fastapi application. ',
	...
	},
	{
		...
		description:
			'You have alembic setted up and you made revisions to your models.py file. You want to update your database with the new changes.',
		prompt: 'Provide the terminal commands for it',
		example:
			"alembic revision --autogenerate -m 'added new column to table'\n\
	...
	},
	{
		...
		exmaple:
			'Yes, HERE I AM SKIPPING event table: \
...
const dot_net = [
	{
		...
		description:
			'Object Relational Mapping (ORM) is the process of mapping between objects and relational database systems. It is a programming technique that allows us to query and manipulate data from a database using an object-oriented paradigm.',
		example:
			'Entity Framework is an example of an ORM\n\
        Which features are: \n\
	...
	},
	{
		...
		example:
			'Create the model inside of entities, Then include the dataContext\n\
...
const angular = [
	...
	},
	{
		...
		description:
			'app.UseCors( builder => builder.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader().WithOrigins("http://localhost:4200")); ',
		example:
			'Go to Program.cs and add the following line to the Configure method:'
	},
	{
	...
	},
	{
		...
		example:
			'Install mkcert using brew or choco\n\
        mkdir ssl\n\
        cd ssl\n\
        mkcert localhost\n\
	...
	},
	{
		...
		example:
			"<div [ngClass]='{error: errorExists, success: !errorExists}'></div>",
		description:
			'ngClass is a directive that allows you to set more than one CSS class on an element. It can accept an object, a string, or an array of strings. The ngClass directive behaves very similarly to how ngStyle behaves.'
	},
	{
		term: 'ng style',
		prompt: "using 'size' set font-size to 'x-large' if size is 1, 'large' if size is 2",
		example:
			"<div [ngStyle]='{fontSize: size === 1 ? 'x-large' : 'large'}'></div>"
	},
	{
		...
		description:
			'You would use it by having in your component:\n\
	...
	},
	{
		...
		description:
			'Iterate over the users list where each user has a name property'
	},
	{
		term: 'ngIf',
		...
		description:
			'ngIf is a directive that allows you to conditionally add or remove an element from the DOM. It can accept an expression that evaluates to true or false. If the expression evaluates to true then the element is added to the DOM, otherwise it is removed.'
	},
	{
		term: 'ngSwitch',
		...
		description:
			'ngSwitch is a directive that conditionally adds or removes an element from the DOM based on an expression. It behaves similarly to the JavaScript switch statement.'
	},
	{
		term: 'template',
		...
		description:
			'ng-template is an Angular element for rendering HTML. It is never displayed directly. In fact, before rendering the view, Angular replaces the ng-template and its contents with a comment.'
	},
	{
		term: 'form and click',
		prompt: 'Create a form that will show the name of the user when clicking the button',
		example:
			"<form (submit)='showUser()'>\n\
	...
	},
	{
		...
		description:
			"It would be used as the following: \n\
        {{year | seniorJunior}}\n\
	...
	// TODO Add more of NgRx State, Action, Reducer, Effect Problems https://www.youtube.com/watch?v=f97ICOaekNU
	{
		...
		description:
			'Is the container of the state to help writting consistent applications'
	},
	{
		term: 'Lazy Loading and Child Routes',
		prompt: 'How to add lazy loading and child routes?',
		description:
			"Here is what you would have int he dashboard.module.ts\n\n\
        const routes: Routes = [\n\
                  {\n\
                    path: 'feature',\n\
	...
	},
	{
		...
		description:
			"An Example of how guard is generated.\n\
        import { Injectable } from '@angular/core';\n\
        import {\n\
              CanActivate,\n\
...
const postgresql = [
	...
	},
	{
		...
		example:
			'SELECT generate_series(1, (SELECT MAX(user_id) FROM users)) AS user_id;'
	},
	{
		...
		example:
			"SELECT MAX(price) FILTER (WHERE category = 'Electronics') AS max_price_electronics FROM products;",
		description:
			'In summary, you use the WHERE clause to filter rows in the table before aggregation, and you use the FILTER clause to filter rows within an aggregate function after aggregation. The choice between them depends on your specific use case. If you need to filter rows before aggregation, use WHERE. If you need to apply an aggregate function to a subset of rows based on a condition, use FILTER. They are complementary features in SQL and serve different purposes.'
	},
	{
		...
		example:
			"-- Create a view to display student names and course names\n\
    ...
    ORDER BY rt.timeslot_local DESC;',
		description:
			'table: timeslot {event_guid: string, timeslot_local: datetime}\n\
