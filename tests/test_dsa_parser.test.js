...
describe('DSA Markdown Parser', () => {
    describe('parseMarkdownProblems', () => {
        it('should parse a single markdown file with multiple problems', () => {
            const testFilePath = path.join(__dirname, '../user_data/dsa_modules/leetcode-basics/problems/array-problems.md');
    ...
    describe('parseMarkdownProblemsFromFolder', () => {
        it('should parse all markdown files in a folder', () => {
            const folderPath = path.join(__dirname, '../user_data/dsa_modules/leetcode-basics/problems');
            
            if (!fs.existsSync(folderPath)) {
                console.warn(`Test folder ${folderPath} does not exist, skipping test`);
                return;
            }
            ...
            const maxDepth = problems.find(p => p.title === 'Maximum Depth of Binary Tree');
            assert(maxDepth);
        });
    });
    ...
    describe('convertToProblemsMetadata', () => {
        it('should convert parsed problems to ProblemMetadata format', () => {
            ...
            const metadata = convertToProblemsMetadata(mockProblems, 'Test Module');
    ...
    describe('parseMarkdownProblemsFromModules', () => {
        it('should parse problems from module configuration', () => {
            ...
            const testDir = path.join(__dirname, '../user_data/dsa_modules/test-module/problems');
            ...
            try {
                ...
                fs.writeFileSync(testFile, `# Test Problem
...
`);
                ...
                console.warn('Could not create test files, skipping integration test:', error.message);
            }
        });
    });
});